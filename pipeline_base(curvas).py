...
OUTPUT_VIDEO_PATH = "resultado_video_curvas.avi"
DIAGRAMA_PATH = "pipeline_steps_curve.png"
# ================================================================
# 1. CARGA DE VIDEO
# ================================================================
def open_video(path):
...
def show_pipeline_diagram(frame, debug_images):
    ...
    cmaps = [None, None, 'gray', 'gray', 'gray', None]
...
if __name__ == "__main__":
    ...
    if not os.path.exists(VIDEO_PATH):
        ...
        print("Asegúrate de que la carpeta 'imagenes/' contiene 'video_curvas.mp4'")
        sys.exit(1)
    else:
        process_video(
