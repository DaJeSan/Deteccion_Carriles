...
OUTPUT_VIDEO_PATH = "resultado_mejora3_curvas_kalman.avi"
DIAGRAMA_PATH     = "pipeline_mejora3_curvas_steps.png"
...
# ================================================================
# 5. FILTRO DE COLOR HSV (recalibrado curvas + sombras + anti-veg)
# ================================================================
...
# ================================================================
# 10. BUFFER DE HISTORIAL + DETECCIÓN DE OUTLIERS
# ================================================================
class LaneHistory:
...
# ================================================================
# 11. ESTABILIZADOR TEMPORAL COMPLETO (Kalman + Buffer)
# ================================================================
...
def lane_to_coords(slope, intercept, image_shape):
    ...
    y_bottom = int(0.92 * height)
    y_top    = int(0.60 * height)
...
def show_pipeline_diagram(frame, debug_images):
    ...
    fig.suptitle(
        "Pipeline Mejora 3 — Estabilización Kalman (curvas)",
...
def process_video(video_path, show_preview=True, save_video=True):
    ...
    while True:
        ...
        if show_preview:
            ...
            cv2.imshow("Mejora 3 — Kalman estabilizado (curvas)", result)
...
if __name__ == "__main__":
    print("=" * 60)
    print("  MEJORA 3: Estabilización Kalman + buffer deque (curvas)")
    print("  HSV(Y:H15-35,S35,V80 | B:S35,V120) + anti-veg + morph")
    print("  Canny(50/150) → HoughLinesP → Kalman[pendiente,intercepto]")
    print("  Buffer N=8 frames   Outlier sigma=2.0   ROI ampliada curvas")
    print("=" * 60)
